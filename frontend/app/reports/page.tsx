...
export default async function ReportsPage() {
  ...
  return (
    <AppShell user={user} role={role} title="Executive Briefings & Reports">
        ...
        <div className="p-8 rounded-2xl border border-slate-800 bg-slate-900/40 backdrop-blur">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-lg font-bold text-white">Automated Report Generator</h2>
                <p className="text-xs text-slate-400">PDF Briefings, Exec Summaries, & Evidence Citation Cards</p>
              </div>
            </div>
          ...
          <div className="p-12 rounded-xl border border-dashed border-slate-800 bg-slate-950/60 text-center">
            ...
            <h3 className="text-sm font-semibold text-slate-200">Reports Engine Shell Prepared</h3>
            <p className="mt-1 text-xs text-slate-500 max-w-md mx-auto">
              Automated multi-page PDF generation, Markdown summaries, and citation compilation will connect in Phase 13.
            </p>
          </div>
        </div>
      </div>
